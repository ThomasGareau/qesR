...
Les champs harmonisés incluent la démographie (âge, genre, éducation,
revenu), le choix de vote, l’identification partisane, les attitudes
envers la souveraineté, les thermomètres de chefs, et plus encore.
Utilisez `colnames(master)` pour voir la liste complète.
