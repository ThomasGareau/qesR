---
title: "Cas d'usage : évolution des attitudes liées à la souveraineté"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Cas d'usage : évolution des attitudes liées à la souveraineté}
...
ymax_sov <- suppressWarnings(max(plot_sov$ci_haut, plot_sov$taux, na.rm = TRUE))
ymax_sov <- if (is.finite(ymax_sov)) min(1, ymax_sov + 0.05) else 1
