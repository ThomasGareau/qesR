...
knitr::kable(
  ...
  digits = 1,
  caption = "Parts de choix de vote des principaux partis par annee (incluant le PCQ)"
)
```
...
ggplot(vote_parti, aes(x = annee, y = part, color = choix_vote_parti, group = choix_vote_parti)) +
  ...
  scale_x_continuous(
    breaks = sort(unique(vote_parti$annee)),
    guide = guide_axis(n.dodge = 2)
  ) +
  labs(
    title = "Choix de vote des principaux partis dans le temps (incluant le PCQ)",
    x = "Année d'étude",
