---
title: "Study Citations"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Study Citations}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

These are the studies currently used in `qesR` and in the merged dataset workflow.
...
For manuscript references, include DOI and access date; where required by journals, copy the repository's recommended citation text from the DOI landing pages above.
