---
title: "Use case example: Vote Choice Over Time"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Use case example: Vote Choice Over Time}
...
ggplot(vote_party, aes(x = year_index, y = share, color = vote_choice_party, group = vote_choice_party)) +
  ...
  scale_color_manual(values = party_cols, name = "Party") +
...
- Years 2009 and 2010 come from `qes_crop_2007_2010` after splitting by collection year.
